...
import Light from './assets/light effect-03 1.png'
    ...
    <div className="App">
      <div className='hero-page'>
        <Container >
          ...
          <Row className='mt-5'>
            <Col className='col-12 col-lg-6 text-center hero-cont'>
              ...
              <div className='d-flex align-items-center justify-content-center'>
                <a href='#' className='m-2'><Image src={appStore} alt='appstore' className='img-fluid' /></a>
                <a href='#' className='m-2'><Image src={goolePlay} alt='gooleplay' className='img-fluid' /></a>
              </div>
              <a className='price-link mt-4' href='#'>See Pricing Options</a>
            </Col>
            <Col className='col-12 col-lg-6 text-center'>
              <form className='login-form px-0 px-sm-5'>
                ...
                <div className='d-flex justify-content-end'>
                  <a className='forgit-pass' href='#'>Forgot Password?</a>
                </div>
                <button type="submit" className='mt-3'>Send Your Message</button>
              </form>
